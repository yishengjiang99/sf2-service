...
export function loadProgram({ url, presetRefs, heap, shdrref, sdtaStart, programNames }, pid, bkid = 0) {
  ...
  function getShdr(SampleId) {
    ...
    let [start, end, startloop, endloop, sampleRate] = new Uint32Array(dv, 20, 5);
